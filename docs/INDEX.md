...
- **Phase 3 Screen Specs:** Today, Plan, Capture, Journey, Me, Search, Settings, Weekly Review and core detail behavior drafted
...
- **Phase 6 Personal Intelligence:** deterministic V1 rules drafted
...
- **Astra build handoff:** not ready yet; remaining blockers are now mainly visual-reference approval + final freeze/recheck
